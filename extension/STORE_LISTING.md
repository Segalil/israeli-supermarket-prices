...
התוסף סוגר את המעגל: אחרי שבחרתם באתר את הרשת המשתלמת ביותר, הוא מלווה אתכם
באתר הרשת ומעביר את הרשימה לעגלה — פריט אחרי פריט:
...
• לחצן התוסף מציג בכל רגע אם רשימה ממתינה להעברה

פרטיות מלאה: התוסף לא מבקש סיסמאות, לא מתחבר בשמכם ולא שולח מידע לשום שרת.
הרשימה נשמרת מקומית בדפדפן בלבד, וההעברה מתבצעת בתוך החשבון שלכם ובשליטתכם
המלאה.
...
**Privacy policy URL:**
https://slim-super.com/privacy.html
